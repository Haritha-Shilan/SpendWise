        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CategoryMaster_CategoryTypeMaster_TypeId",
                        column: x => x.TypeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserCategory_CategoryTypeMaster_TypeId",
                        column: x => x.TypeId,
                        principalTable: "CategoryTypeMaster",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transaction_UserCategory_UserCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TransactionAttachment_Transaction_TransactionId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, true, "Debit Card" },
                    { 4, true, "UPI" },
                    { 5, true, "Bank Transfer" }
                });

            migrationBuilder.InsertData(
                table: "CategoryMaster",
                columns: new[] { "Id", "IsActive", "Name", "TypeId" },
                values: new object[,]
                {
                    { 1, true, "Food", 1 },
                    { 2, true, "Transport", 1 },
                    { 3, true, "Shopping", 1 },
                    { 4, true, "Bills", 1 },
                    { 5, true, "Entertainment", 1 },
                    { 6, true, "Healthcare", 1 },
                    { 7, true, "Education", 1 },
                    { 8, true, "Salary", 2 },
                    { 9, true, "Business", 2 },
                    { 10, true, "Investment", 2 },
                    { 11, true, "Gift", 2 },
                    { 12, true, "Other Income", 2 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryMaster_Name_TypeId",
                table: "CategoryMaster",
                columns: new[] { "Name", "TypeId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CategoryMaster_TypeId",
                table: "CategoryMaster",
                column: "TypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transaction_UserCategoryId",
                table: "Transaction",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserCategory_TypeId",
                table: "UserCategory",
                column: "TypeId");

            migrationBuilder.CreateIndex(
                name: "IX_UserCategory_UserId_TypeId_Name",
                table: "UserCategory",
                columns: new[] { "UserId", "TypeId", "Name" },
                unique: true);
        }
